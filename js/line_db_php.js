...
$(document).ready(function () {
	 ...
	 */
	$.ajax({
		url: "http://35.196.202.152/api/cff_data.php",
		type: "GET",
			...
			var data = {
				...
				datasets: [
					...
					//graph2 data
					{
						...
						data: to_array1,
						backgroundColor: "rgba(84, 200, 242,0.4)",
						borderColor: "rgba(84, 200, 242,1)",
						fill: true,
						lineTension: 0,
						pointRadius: 5
					...
					//graph4
					{
						...
						data: to_array3,
						backgroundColor: "rgba(150, 120, 24,0.4)",
						borderColor: "rgba(150, 120, 24,1)",
						fill: true,
						lineTension: 0,
						pointRadius: 5
					}
